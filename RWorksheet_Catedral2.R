...
x <- 1:7
x
#So, the value of x is a vector containing the numbers 1 through 7.
#2.
...
third_element
#B. second_element <- ages[2] fourth_element <- ages[4] c(second_element, fourth_element)
#C. filtered_ages <- ages[-c(4, 12)] filtered_ages
